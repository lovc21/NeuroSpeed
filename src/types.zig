...
pub const Board = struct {
    ...
    pub inline fn set_pieces(self: *Board, comptime c: Color) Bitboard{
        ...
        self.pieces[Piece.BLACK_PAWN.toU4()] | self.pieces[Piece.BLACK_KNIGHT.toU4()] | self.pieces[Piece.BLACK_BISHOP.toU4()] | self.pieces[Piece.BLACK_QUEEN.toU4()] | self.pieces[Piece.BLACK_KING.toU4()];

    }

    pub inline fn set_white(self: *Board) Bitboard {
        return  self.pieces[Piece.WHITE_PAWN.toU4()] | self.pieces[Piece.WHITE_KNIGHT.toU4()] | self.pieces[Piece.WHITE_BISHOP.toU4()] | self.pieces[Piece.WHITE_QUEEN.toU4()] | self.pieces[Piece.WHITE_KING.toU4()]; 
    }

    pub inline fn set_black(self: *Board) Bitboard {
        return  self.pieces[Piece.BLACK_PAWN.toU4()] | self.pieces[Piece.BLACK_KNIGHT.toU4()] | self.pieces[Piece.BLACK_BISHOP.toU4()] | self.pieces[Piece.BLACK_QUEEN.toU4()] | self.pieces[Piece.BLACK_KING.toU4()];
    }
};
